...
<form action="./" method="post" id="docUploadForm" enctype='multipart/form-data'>
<ul class="inlined">
...
<p>
<b>Важно:</b> документ следует загружать одним файлом. Если документ состоит из нескольких отсканированных изображений, упакуйте их в один архивный файл (rar, zip, 7z) или вставьте в один файл doc или pdf. Один документ – не более {[Math.round(values.maxSize/1024/1024)]}Мб.
</p>
</form>
</div>
{{include 'docs.inc'}}
