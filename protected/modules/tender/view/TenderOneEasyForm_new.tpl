...
<div class="tndr_form bid_form fold">
    ...
    <ul class="inlined">
		...
		<li class="form_text">2Примечание</li><li class="form240"><div class="input_wrap"><textarea name="notes" data-bind="value: v.notes"></textarea></div></li>
		<li class="form_alert" style="display: none;">Обязательное поле</li><br>
        ...
        <li class="form_text two_lines">Предложение </li><li class="form240"><div class="input_wrap file_wrap"><input type="file" name="file1"><div class="file_dummy">Выберите файл...</div></div></li>
...
<tpl if="positions">
<h2 class="folder">Предлагаемые цены по позициям тендера<a href="#block" class="tndr_btn"  onclick="return false"></a></h2>
<div class="tndr_form bid_form fold">
    <p><span data-bind="text: finTimePhrase"></span> <span data-bind="text: finTime"></span></p>
